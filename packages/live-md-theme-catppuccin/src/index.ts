...
function catppuccinLiveMdVariables(colors: CatppuccinColors): LiveMdThemeColorVariables {
  return {
    ...
    "--live-md-mermaid-border": `color-mix(in srgb, ${colors.blue} 38%, ${colors.base})`,
    "--live-md-mermaid-line": colors.overlay2,
    "--live-md-mermaid-muted": colors.subtext0,
    "--live-md-mermaid-surface": `color-mix(in srgb, ${colors.blue} 9%, ${colors.base})`,
