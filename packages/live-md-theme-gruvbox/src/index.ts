...
function gruvboxLiveMdVariables(colors: GruvboxColors): LiveMdThemeColorVariables {
  return {
    ...
    "--live-md-mermaid-border": `color-mix(in srgb, ${colors.green} 38%, ${colors.bg0})`,
    "--live-md-mermaid-line": colors.fg4,
    "--live-md-mermaid-muted": colors.fg2,
    "--live-md-mermaid-surface": `color-mix(in srgb, ${colors.green} 9%, ${colors.bg0})`,
