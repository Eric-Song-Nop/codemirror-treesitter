...
describe("useWorkspaceEntryDialogs selected document ordering", () => {
  ...
  it("clears the selected document view before deleting and refreshing", async () => {
    let events: string[] = [];
    let options = createOptions(events);
