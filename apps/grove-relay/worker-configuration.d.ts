/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 358b830b33b677d4bcb6563334ab969d)
// Runtime types generated with workerd@1.20260526.1 2026-05-28 nodejs_compat
interface __BaseEnv_Env {
	CREATE_SHARE_RATE_LIMITER: RateLimit;
	SHARE_SESSION_RATE_LIMITER: RateLimit;
	SHARE_WEBSOCKET_RATE_LIMITER: RateLimit;
	GROVE_CREATE_QUOTA: DurableObjectNamespace<import("./src/worker").GroveCreateQuota>;
	GROVE_SHARE_ROOMS: DurableObjectNamespace<import("./src/worker").GroveShareRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "GroveShareRoom" | "GroveCreateQuota";
	}
